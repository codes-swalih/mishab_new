...
const MenuFurniture: React.FC<Props> = ({ props }) => {
  ...
  const navLinks = [
    { href: "/pages/become-a-seller", label: "Become a Seller" },
                ...
                <div className="flex items-center gap-4 py-2 text-xs">
                  {navLinks.map((link, idx) => (
                    <React.Fragment key={link.href}>
                      {idx > 0 && <span className="w-px h-3 bg-line" />}
                      <Link
                        href={link.href}
              ...
              <div className="hidden lg:block flex-1 max-w-[560px] mx-6">
                <div className="form-search relative z-[1]">
                  ...
                  <input
                    ...
                    className="h-10 rounded-full bg-gray-100 caption2 w-full pl-9 pr-4"
                    value={searchKeyword}
          ...
          <div className="container mx-auto pt-5">
            <div className="form-search relative">
              ...
              <input
                ...
                className="h-12 rounded-full bg-gray-100 text-black border border-line caption2 w-full pl-9 pr-4"
                value={searchKeyword}
                onChange={(e) => setSearchKeyword(e.target.value)}
                onKeyDown={(e) =>
                  e.key === "Enter" && handleSearch(searchKeyword)
