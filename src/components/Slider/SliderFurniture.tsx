...
const SliderFurniture = () => {
    ...
    return (
        <>
            <div className="slider-block style-two md:bg-linear 2xl:h-[520px] xl:h-[480px] lg:h-[440px] md:h-[400px] sm:h-[360px] h-[200px] container py-5 rounded-xl w-full">
                <div className="slider-main h-full w-full rounded-xl">
                    <Swiper
                        spaceBetween={0}
                        slidesPerView={1}
                    ...
                    >
                        {banners.map((banner, index) => (
                            <SwiperSlide key={index}>
                                <div className="slider-item h-full w-full relative rounded-2xl">
                                    <div className="container w-full h-full flex flex-col rounded-2xl  text-center items-center justify-center">
                                        <div className="text-content sm:w-[55%] w-2/3">
                                            ...
                                            <Link href={banner.linkUrl} className="button-main bg-white text-black md:mt-4 mt-3">Shop Now</Link>
                                        </div>
