          ...
          <div className="flex justify-between max-lg:flex-col gap-y-10">
            <div className="left lg:w-2/3 lg:pr-4">
              ...
              <form className="md:mt-6 mt-4" onSubmit={handleSubmit}>
                <div className="grid sm:grid-cols-2 grid-cols-1 gap-4 gap-y-5">
                  <div className="name ">
                    <input
                      className="border-line px-4 border border-gray-400 py-3 w-full rounded-lg"
                      id="name"
                      type="text"
                  ...
                  <div className="email">
                    <input
                      className="border-line px-4 pt-3  border border-gray-400 pb-3 w-full rounded-lg"
                      id="email"
                      type="email"
                  ...
                  <div className="message sm:col-span-2">
                    <textarea
                      className="border-line px-4  border border-gray-400 pt-3 pb-3 w-full rounded-lg"
                      id="message"
                      rows={3}
            ...
            <div className="right lg:w-1/4 lg:pl-4">
              <div className="item">
                ...
                <p className="mt-3">
                  Phone:{" "}
                  <span className="whitespace-nowrap">+91 8590318931</span>
                </p>
                <p className="mt-1">
                  Email:{" "}
