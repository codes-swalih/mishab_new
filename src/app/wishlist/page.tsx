...
const Wishlist = () => {
  ...
  if (sortOption === "discountHighToLow") {
    filteredData = sortedData.sort(
      (a, b) =>
        Math.floor(
          100 - (((b as any).salePrice ?? b.price) / b.originPrice) * 100
        ) -
        Math.floor(
          100 - (((a as any).salePrice ?? a.price) / a.originPrice) * 100
        )
    );
  }
  ...
  if (sortOption === "priceHighToLow") {
    filteredData = sortedData.sort(
      (a, b) =>
        ((b as any).salePrice ?? b.price) - ((a as any).salePrice ?? a.price)
    );
  }
  ...
  if (sortOption === "priceLowToHigh") {
    filteredData = sortedData.sort(
      (a, b) =>
        ((a as any).salePrice ?? a.price) - ((b as any).salePrice ?? b.price)
    );
  }
  ...
  return (
    <>
      ...
      <div className="shop-product breadcrumb1 lg:py-20 md:py-14 pt-5 pb-10 min-h-screen">
            ...
            <div className="list-filtered flex items-center gap-3 mt-4">
              <div className="total-product">
                <div className=" flex flex-col md:gap-2">
                    <h1 className=" heading3">Wishlist</h1>
                  <div>
                    {totalProducts}
